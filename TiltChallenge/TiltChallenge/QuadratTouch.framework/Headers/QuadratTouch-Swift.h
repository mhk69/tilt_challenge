...
/// The class where AuthorizationViewController is pushed. It does nothing. You may use this class to apply you application style via UIAppearence.
...
- (void)sessionWillPresentAuthorizationViewController:(AuthorizationViewController * __nonnull)controller;
- (void)sessionWillDismissAuthorizationViewController:(AuthorizationViewController * __nonnull)controller;
@end
